...
<div class="row justify-content-center">
    <div class="col-lg-7">
        <div class="card shadow-sm">
            <div class="card-body">
                <h2 class="h5 mb-4">Tambah Anggota Baru</h2>
                <form method="POST" action="{{ route('admin.members.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="member_id_number" id="member_id_number" class="form-control @error('member_id_number') is-invalid @enderror" value="{{ old('member_id_number') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="total_points" id="total_points" class="form-control @error('total_points') is-invalid @enderror" value="{{ old('total_points', 0) }}">
